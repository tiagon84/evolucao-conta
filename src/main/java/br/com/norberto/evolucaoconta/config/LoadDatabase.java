...
class LoadDatabase {
  ...
  private ContaEnergia createConta1() {
    return new ContaEnergia(LocalDate.of(2019, Month.JANUARY, 1),
        LocalDate.of(2020, Month.JANUARY, 1), new BigDecimal("54.3"), StatusConta.ABERTA,
        Month.FEBRUARY, "123", "321", 48.1);
  }
  ...
  private ContaEnergia createConta3() {
    return new ContaEnergia(LocalDate.of(2019, Month.SEPTEMBER, 16),
        LocalDate.of(2019, Month.DECEMBER, 5), new BigDecimal("45.7"), StatusConta.PAGA,
        Month.OCTOBER, "687", "876", 11.1);
  }
}
